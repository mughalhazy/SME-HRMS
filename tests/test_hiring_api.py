...
class HiringApiTests(unittest.TestCase):
    ...
    def test_job_posting_crud_api_flow(self) -> None:
        ...
        self.assertEqual(missing['meta']['request_id'], 'trace-missing')
    ...
    def test_candidate_and_interview_api_flow(self) -> None:
        ...
        self.assertEqual(status, 200)
        self.assertEqual(candidate_list['meta']['pagination']['count'], 1)
        ...
        self.assertEqual(status, 200)
        self.assertEqual(pipeline['meta']['pagination']['count'], 1)
        ...
        self.assertEqual(status, 200)
        self.assertEqual(interview_list['meta']['pagination']['count'], 1)
    ...
    def test_api_reports_validation_and_conflict_errors(self) -> None:
        ...
        self.assertEqual(invalid['meta']['request_id'], 'trace-invalid-limit')
        ...
        self.assertEqual(conflict['meta']['request_id'], 'trace-conflict')
