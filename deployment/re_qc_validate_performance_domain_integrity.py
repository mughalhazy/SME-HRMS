...
checks: list[tuple[str, bool]] = [
    ...
    ('workflow documentation captures enterprise lifecycle', all(token in WORKFLOW_DOC for token in ['ReviewCycle: none -> Draft -> Open -> Closed', 'Goal: none -> Draft -> Submitted -> Approved/Rejected', 'PipPlan: none -> Draft -> Submitted -> Active/Rejected -> Completed/Cancelled'])),
