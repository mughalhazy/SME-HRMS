...
import { CalendarDays, CheckCircle2, Clock3, Download, TriangleAlert, UserRoundX } from 'lucide-react'
...
type AttendanceFlag = 'Late arrival' | 'Missing check-in' | 'Missing check-out' | 'Attendance anomaly'
...
export function Attendance() {
  ...
  const selectedRow = useMemo(() => {
    return filteredRows.find((row) => row.id === selectedRowId) ?? filteredRows[0] ?? null
