...
const INITIAL_CANDIDATES: CandidateRecord[] = [
  ...
  },
  {
    ...
    updatedAt: '2026-03-16T13:15:00.000Z',
  ...
  },
  {
    ...
    updatedAt: '2026-03-17T17:20:00.000Z',
    summary: 'Accepted offer and is queued for onboarding handoff.',
  },
]

const INITIAL_INTERVIEWS: InterviewRecord[] = [
  {
    id: 'int-001',
    candidateId: 'cand-003',
    interviewType: 'Panel',
    scheduledAt: '2026-03-19T14:30:00.000Z',
                        ...
                        {candidateStage === 'Interview' ? (
                          <div className="mt-4 rounded-[22px] border border-violet-200 bg-violet-50/70 p-3">
                            ...
                            <div className="grid gap-2">
                              ...
                              <Button className="mt-1 w-full" onClick={() => handleScheduleInterview(candidate.id)}>
                                Schedule interview
                              </Button>
                            </div>
                          </div>
