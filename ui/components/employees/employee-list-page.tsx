...
import { PageSection, PageStack } from '@/components/ui/page'
      ...
      <Table className="table-fixed">
        ...
        <TableBody>
          {Array.from({ length: 8 }).map((_, index) => (
            <TableRow key={index} className="h-[72px] border-b border-slate-200 hover:bg-transparent">
              ...
              <TableCell className="px-4 py-4 md:px-6"><Skeleton className="h-4 w-24" /></TableCell>
              <TableCell className="px-4 py-4 md:px-6"><Skeleton className="h-4 w-28" /></TableCell>
              <TableCell className="px-4 py-4 md:px-6"><Skeleton className="h-6 w-20 rounded-full" /></TableCell>
              <TableCell className="px-4 py-4 md:px-6"><Skeleton className="h-4 w-24" /></TableCell>
              <TableCell className="px-4 py-4 md:px-6">
  ...
  return (
    <PageStack className="gap-4">
      <PageSection className="min-w-0 overflow-hidden shadow-none">
        <div className="grid gap-4 p-4 lg:grid-cols-[minmax(0,1.7fr)_repeat(3,minmax(160px,0.8fr))_auto] lg:items-center lg:p-5">
          ...
          <Select className="h-11" value={departmentId} onChange={(event) => setDepartmentId(event.target.value)}>
          ...
          <Select className="h-11" value={roleId} onChange={(event) => setRoleId(event.target.value)}>
          ...
          <Select className="h-11" value={status} onChange={(event) => setStatus(event.target.value as (typeof EMPLOYEE_STATUSES)[number] | 'all')}>
      ...
      <PageSection className="min-w-0 overflow-hidden shadow-none">
        <div className="flex flex-col gap-3 border-b border-slate-200 px-4 py-4 text-sm text-slate-500 md:flex-row md:items-center md:justify-between md:px-6">
        ...
        {query.isLoading ? (
          ...
          <ErrorState
            className="rounded-none border-x-0 border-b-0 border-t border-rose-200 bg-rose-50/60 px-0 py-6 shadow-none"
          ...
          <div className="min-w-0">
            <Table className="table-fixed">
              ...
              <TableHeader className="bg-slate-50/90">
                <TableRow className="h-12 border-b border-slate-200 bg-transparent hover:bg-transparent hover:shadow-none">
                  <TableHead className="px-4 py-3 md:px-6">Name</TableHead>
                  <TableHead className="px-4 py-3 md:px-6">Role</TableHead>
                  <TableHead className="px-4 py-3 md:px-6">Department</TableHead>
                  <TableHead className="px-4 py-3 md:px-6">Status</TableHead>
            ...
            {query.hasNextPage ? (
              <div className="flex justify-end border-t border-slate-200 px-4 py-4 md:px-6">
