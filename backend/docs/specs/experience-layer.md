...
- **Implementation:** `services/payroll/paas.py`
...
| Component | File |
|---|---|
| ExperienceLayerService, FinancialWellnessHook | `services/product/experience.py` |
| TierEnforcer (tier gating logic) | `services/product/tier_enforcer.py` |
| Experience layer middleware | `services/product/middleware.py` |
| Payroll-as-a-Service (PaaS mode) | `services/payroll/paas.py` |
