...
> NOTE (2026-06-13): `hrms-doc-catalogue-v1.md` Category 13 entry for this file lists employee/notification/reporting-analytics/hiring/auth/settings APIs under "Newly wrapped endpoints" — but per this file's own sections below, only `payroll_api.py` was newly wrapped to D1; those other APIs are listed under "Already compliant or largely compliant before change" (a different category). This file's content is canonical; the catalogue description needs reconciling in a future catalogue-fix pass.
