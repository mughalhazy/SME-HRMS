...
> NOTE (2026-06-13): `hrms-doc-catalogue-v1.md` Category 13 entry for this file describes "10 QC dimensions" including event contract conformance, API standard compliance, domain boundary respect, read-model contract alignment, and security model coverage — but the "QC Dimensions" section below lists only 7 items, ending at "Service boundary adherence". This file's content is canonical; the catalogue description needs reconciling in a future catalogue-fix pass.
