...
SCOPE NOTE: This file governs the backend repo seed pages (p1-p13.html). Its 5 structural archetypes (§19: Command Center, Data Directory, Analytics/Evaluation, Pipeline, Form/Config) define layout templates for seed pages. For the Meridian HCM project archetype system (13 archetypes H01-H13 mapped to service contracts), see docs/hrms-archetype-system-v1.md. The built pages (h01-h13.html) are governed by design-language.html as the source of truth for tokens and components.
