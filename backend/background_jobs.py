...
class BackgroundJobService:
    def __init__(
        ...
        *,
        ...
        self.default_timeout_seconds = 1.0
    ...
    def register_handler(self, job_type: str, handler: JobHandler, *, max_attempts: int | None = None, timeout_seconds: float | None = None) -> None:
    ...
    def execute_job(self, job_id: str, *, tenant_id: str, trace_id: str | None = None) -> JobRecord:
        ...
        try:
            result = run_with_retry(
                ...
                base_delay=0.001,
                timeout_seconds=self.job_types.get(job.job_type, {}).get('timeout_seconds', self.default_timeout_seconds),
