"""
Recruitment Utilities — services/recruitment/service.py
========================================================
CV parsing, candidate scoring, candidate ranking, and onboarding checklist generation.

This is a **domain utilities module**, NOT a standalone service.
The canonical hiring workflow service is: services/hiring_service/service.py

These utilities are intended to be imported by hiring_service to perform:
  - CV text/PDF parsing → CandidateProfile
  - Skill matching and experience scoring → CandidateScore
  - Candidate ranking (for shortlisting)
  - Onboarding checklist generation post-hire

There is no HTTP surface here. No DB access. Pure business logic.
To expose these capabilities over HTTP, use hiring_service or hiring_api.py.
"""
