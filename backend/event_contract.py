...
CANONICAL_EVENT_TYPES: dict[str, str] = {
    ...
    "ProjectAssignmentRequested": "project.assignment.requested",
    "ProjectAssignmentAllocated": "project.assignment.allocated",
    ...
    "HelpdeskTicketAttachmentAdded": "helpdesk.ticket.attachment_added",
    "HelpdeskTicketCommentAdded": "helpdesk.ticket.comment_added",
    "HelpdeskTicketSubmitted": "helpdesk.ticket.submitted",
    "HelpdeskTicketInProgress": "helpdesk.ticket.in_progress",
    "HelpdeskTicketResolved": "helpdesk.ticket.resolved",
    "HelpdeskTicketRejected": "helpdesk.ticket.rejected",
    "HelpdeskTicketClosed": "helpdesk.ticket.closed",
    "HelpdeskTicketReopened": "helpdesk.ticket.reopened",
    "HelpdeskTicketSlaEscalated": "helpdesk.ticket.sla_escalated",
    ...
    "WorkforceIntelligenceProjectionRebuilt": "workforce_intelligence.projection.rebuilt",
    "WorkforceIntelligenceReportDefined": "workforce_intelligence.report.defined",
    "WorkforceIntelligenceReportRunGenerated": "workforce_intelligence.report_run.generated",
    "WorkforceIntelligenceScheduleCreated": "workforce_intelligence.schedule.created",
    "CostPlanningPlanSubmitted": "cost_planning.plan.submitted",
    "CostPlanningPlanApproved": "cost_planning.plan.approved",
    "CostPlanningPlanRejected": "cost_planning.plan.rejected",
    "WorkflowEventConsumed": "workflow.event.consumed",
    # G43 — travel-service events
    ...
    # G44 — compensation / salary / benefits / allowance events
    ...
    # G45 — auth + engagement events missing from catalog
    "UserAccountStatusChanged": "auth.user.account.status_changed",
    "EngagementSurveyResultsAggregated": "engagement.survey.results_aggregated",
    # G46 — settings-service workflow events
    "AttendanceRuleConfigured": "settings.attendance_rule.configured",
    "LeavePolicyConfigured": "settings.leave_policy.configured",
    "PayrollSettingsConfigured": "settings.payroll_settings.configured",
    "SettingsPublished": "settings.published",
    # G49 — compliance-service events
    "ComplianceSubmissionCreated": "compliance.submission.created",
    "ComplianceValidationPassed": "compliance.validation.passed",
    "ComplianceValidationFailed": "compliance.validation.failed",
    "ComplianceReportGenerated": "compliance.report.generated",
    "ComplianceSubmitted": "compliance.submitted",
    "ComplianceAcknowledged": "compliance.acknowledged",
    "ComplianceSubmissionFailed": "compliance.submission.failed",
    "ComplianceRetryQueued": "compliance.retry.queued",
    # G49 — decision-service events
    "AnomalyDetected": "decision.anomaly.detected",
    "DecisionCardCreated": "decision.card.created",
    "DecisionCardAcknowledged": "decision.card.acknowledged",
    "DecisionCardOverridden": "decision.card.overridden",
    "DecisionCardDismissed": "decision.card.dismissed",
    "DecisionCardExpired": "decision.card.expired",
    # G49 — ewa-financial-service events
    "EWARequested": "ewa.requested",
    "EWAApproved": "ewa.approved",
    "EWADisbursed": "ewa.disbursed",
    "EWARejected": "ewa.rejected",
    "AdvanceRequested": "ewa.advance.requested",
    "AdvanceApproved": "ewa.advance.approved",
    "AdvanceDisbursed": "ewa.advance.disbursed",
    "AdvanceRejected": "ewa.advance.rejected",
    "RepaymentDeductionInjected": "ewa.repayment_deduction.injected",
    # G49 — bank-service events
    "DisbursementBatchCreated": "bank.disbursement_batch.created",
    "DisbursementSubmitted": "bank.disbursement.submitted",
    "DisbursementConfirmed": "bank.disbursement.confirmed",
    "DisbursementFailed": "bank.disbursement.failed",
    "PaymentConfirmed": "bank.payment.confirmed",
    "PaymentFailed": "bank.payment.failed",
    "ReconciliationCompleted": "bank.reconciliation.completed",
    "ReconciliationExceptionRaised": "bank.reconciliation.exception_raised",
    # G49 — whatsapp-service events
    "WhatsAppIdentityRegistered": "whatsapp.identity.registered",
    "WhatsAppIdentityVerified": "whatsapp.identity.verified",
    "WhatsAppIdentityRevoked": "whatsapp.identity.revoked",
    "WhatsAppSessionStarted": "whatsapp.session.started",
    "WhatsAppSessionExpired": "whatsapp.session.expired",
    "WhatsAppMessageReceived": "whatsapp.message.received",
    "WhatsAppMessageSent": "whatsapp.message.sent",
    "WhatsAppApprovalActioned": "whatsapp.approval.actioned",
    # G49 — reporting-analytics-service events
    "ReportGenerated": "reporting.report.generated",
    "AnomalySignalEmitted": "reporting.anomaly_signal.emitted",
}
