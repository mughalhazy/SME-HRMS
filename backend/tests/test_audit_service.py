...
class AuditServiceTests(unittest.TestCase):
    ...
    def test_python_services_emit_centralized_audit_records_with_before_after(self) -> None:
        ...
        _, leave_payload = leave.create_request('Employee', 'emp-001', 'emp-001', 'Annual', date(2026, 9, 10), date(2026, 9, 12), 'vacation')
    ...
    @pytest.mark.skipif(sys.platform == 'win32', reason='requires tsc (Unix only)')
