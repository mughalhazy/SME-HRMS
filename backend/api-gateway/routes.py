...
ROUTES: tuple[Route, ...] = (
    ...
    Route(name="compliance", path_prefix="/compliance", upstream_service="compliance-service"),
    Route(name="decisions", path_prefix="/decisions", upstream_service="decision-service"),
    Route(name="banking", path_prefix="/banking", upstream_service="bank-service"),
    Route(name="whatsapp", path_prefix="/whatsapp", upstream_service="whatsapp-service"),
)
