...
class AttendanceSource(str, Enum):
    ...
    # MN-G04: Geo-fencing and face recognition are the active market transition (2024-2026).
    # These are capture-source labels only — payroll treats all sources identically.
    GEO_FENCE = "GeoFence"
...
class AttendanceRecord:
    ...
    # MN-G04: Optional location metadata for geo-fence and mobile captures.
    # Schema: {lat, lng, accuracy_meters, fence_id, fence_name}
    # None for biometric/manual/API sources. Payroll ignores this field.
